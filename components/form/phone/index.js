...
import { Image, TextInput, TouchableWithoutFeedback, TouchableOpacity, View } from "react-native";
    ...
    return (
      <Layout style={[styles.container, this.props.style]}>
        <TouchableOpacity
          ...
          disabled={disabled}
        >
          <Layout style={{ borderBottomWidth: 0.5, paddingBottom: 5, flexDirection: 'row', alignItems: 'flex-end' }}>
            <Image
            ...
            <Text category='h6' style={{ marginLeft: 50 }}>{this.getCountryName()}</Text>
          </Layout>
        </TouchableOpacity>
        <Layout style={{ flexDirection: 'row', marginTop: 20 }}>
          <Text category='h6' appearance='hint' style={{ bottom: 1, fontSize: 20 }}>
            +{this.getCountryCode()}
          </Text>
        ...
        {/* <Text category='s1' appearance='hint' style={{ marginTop: 40, marginBottom: 10 }}>
